...
func (mailer *SmtpMailer) SendMail(fromAddress string, toAddresses []string, subject, body string) error {
...
func (mailer *SmtpMailer) formatMessage(fromAddress string, toAddresses []string, subject, body string) []byte {
